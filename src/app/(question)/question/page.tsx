                    ...
                    <Box style={{ 'height': '100%', 'width': '70%' }}>
                        <Flex direction='column' style={{ height: '100%', width: '100%' }} gap='4'>
                            ...
                            <Box style={{ 'height': '10%', 'width': '100%', 'display': 'flex', 'alignItems': 'center' }}>
                                <Text className="pl-8" size='4' weight='light' wrap='pretty' >Find out one substitution for the following phrase from the options given below
                            ...
                            <Box className="gap-8" style={{ 'height': '10%', 'width': '100%', 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center' }}>
                                <Button style={{ borderRadius: '5px' }} size="3" variant='solid'>Save and Next</Button>
                                <Button style={{ borderRadius: '5px' }} size="3" variant='solid'>Clear Response</Button>
                                <Button style={{ borderRadius: '5px' }} size="3" variant='solid'>Save and Mark for Review</Button>
                                <Button style={{ borderRadius: '5px' }} size="3" variant='solid'>Mark for Review and Next</Button>
                            </Box>
                        </Flex>
                    </Box>
