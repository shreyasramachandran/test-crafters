            ...
            <Flex direction='column'>
                <Box className="bg-[#EAF6FA]" height='64px' flexGrow='1' style={{ position: 'sticky', top: 0, zIndex: 10 }}>
                    <Flex className="h-full" justify='between' align='center' px='6'>
                        ...
                        <Flex className="h-full" gap='4' justify='center' align='center'>
                            ...
                            <Button size='4' radius="small" style={{ height: '70%', width: '70%', backgroundColor: '#120052', color: '#FFFFFF' }} variant='solid' onClick={() => router.push('/sign-up')}>Sign Up</Button>
                        </Flex>
                    </Flex>
                </Box>
                <Box className="bg-[#38B6FF]" height='800px' flexGrow='1' position='relative'>
                ...
                <Box className="bg-[#38B6FF]" height='712px' flexGrow='1' id="maximize-prep">
                    <Flex className="h-full" direction='column' gap='6' justify='center' align='center'>
                        ...
                        <Box className="bg-[#EAF6FA]" style={{ height: '55%', width: '70%', boxShadow: '4px 4px 25px 5px rgba(0, 0, 0, 0.25)', padding: 0 }}  >
