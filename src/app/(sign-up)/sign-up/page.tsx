...
export default function Page() {
    ...
    return (
        <Flex height={{ md: '100vh' }} width={{ md: '100vw' }} justify='center' align='center'>
            <Box className="bg-blue-500" style={{ 'height': '75%', 'width': '35%' }}>
                <Flex className="h-full" direction='column' justify='start' gap='4' py='6'>
                    <Box className="bg-green-500" style={{ 'height': '10%', 'width': '20%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Text color='gray' size='6' weight='bold' wrap='pretty'>Sign Up</Text>
                    </Box>
                    <Box className="bg-green-500" style={{ 'height': '10%', 'width': '60%', display: 'flex', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                        <button className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 w-full">
                            <img src="google_icon.svg" alt="Google Sign-In" className="w-5 h-5 mr-2" />
                    ...
                    <Box className="bg-green-500" style={{ 'height': '10%', 'width': '60%', display: 'flex', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                        <Button style={{ 'height': '100%', 'width': '100%', borderRadius: 0 }} size="3" variant='classic'>Sign Up</Button>
                    </Box>
                    <Box className="bg-green-500" style={{ 'height': '10%', 'width': '40%', display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', alignSelf: 'center' }}>
                        <Box className="bg-blue-500" style={{ 'height': '100%', 'width': '70%', display: 'flex', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                            <Text color='gray' size='2' weight='regular' wrap='pretty'>Already signed up?</Text>
                        </Box>
                        <Box className="bg-blue-500" style={{ 'height': '100%', 'width': '30%', display: 'flex', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                            <Text color='gray' size='2' weight='regular' wrap='pretty'>Sign In</Text>
                        </Box>
                    </Box>
                    <Box className="bg-green-500" style={{ 'height': '10%', 'width': '60%', display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }}>
                        <Text color='gray' size='2' weight='regular' wrap='pretty'>By continuing you agree to the WordplayEdu&#x2019;s Terms of Service and Privacy Policy</Text>
                    </Box>
                </Flex>
            </Box >
        </Flex >
