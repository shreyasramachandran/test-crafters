    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            <div className="text-center">
                ...
                <div className="mt-10">
                    <p className="text-gray-800"><span className="font-medium">Email:</span> <a href="mailto:shreyasramachandran@gmail.com" className="text-blue-500 hover:text-blue-600">shreyasramachandran@gmail.com</a></p>
