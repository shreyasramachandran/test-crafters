    ...
    return (
        <ScrollArea type="always" scrollbars="vertical" size="2" style={{ height: '100vh' }}>
            <Flex direction='column'>
                <div style={{ 'borderRadius': '5px', 'boxShadow': '4px 4px 50px 5px rgba(0, 0, 0, 0.25)' }} className="bg-[#38B6FF] flex flex-col items-center justify-center min-h-screen p-6">
                    <div className="bg-[#EAF6FA] rounded-lg shadow overflow-hidden w-full max-w-3xl p-8">
                        ...
                        <ul className="list-disc space-y-2 pl-5">
                            <li className="text-gray-700">
                                By accessing the website at testcrafters.net, you are agreeing to be bound by these terms of service, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws.
                            </li>
                            <li className="text-gray-700">
                            ...
                            <li className="text-gray-700">
                                Our Service may contain links to third-party web sites or services that are not owned or controlled by Test Crafters.
                            </li>
                            <li className="text-gray-700">
                                Test Crafters has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Test Crafters shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods, or services available on or through any such web sites or services.
                            </li>
                            <li className="text-gray-700">
